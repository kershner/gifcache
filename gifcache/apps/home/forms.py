...
class SignupForm(forms.Form):
    username = forms.SlugField(max_length=40, label='', widget=forms.TextInput(attrs={'placeholder': 'Username', 'class': 'main-field animate'}))
    ...
    first_name = forms.CharField(max_length=20, label='', widget=forms.TextInput(attrs={'placeholder': 'Nickname', 'class': 'main-field animate'}))

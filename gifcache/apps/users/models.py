...
class Profile(models.Model):
    ...
    avatar = models.URLField(max_length=400, default='/static/default-user-image.png')
    avatar_thumb = models.ImageField(upload_to='avatars', default='/static/default-user-image.png')
